...
Write-Host "🔍 Starting Prisma Studio on http://localhost:5555..." -ForegroundColor Green
...
Write-Host "📱 Starting Flutter Staff POS App on Chrome (Port 5000)..." -ForegroundColor Green
